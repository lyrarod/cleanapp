...
export const Navbar = () => {
  ...
  return (
    <header className="fixed top-0 left-0 z-50 w-full shadow bg-background/70 backdrop-blur-md dark:border-b">
          ...
          {links.map((link, i) => {
            return (
              <li key={i}>
                <a
                  href={`${link.href}`}
                  className="font-medium tracking-wider capitalize transition hover:text-primary"
                >
                  {link.label}
                </a>
              </li>
